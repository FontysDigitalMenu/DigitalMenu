...
public class TableController(ITableService tableService) : ControllerBase
{
    ...
    public IActionResult Get([FromRoute] string id)
    {
        ...
        TableViewModel tableViewModel = new() { Id = table.Id, Name = table.Name, SessionId = table.SessionId, IsReservable = table.IsReservable };
    ...
    public IActionResult Post([FromBody] TableRequest tableRequest)
    {
        ...
        Table table = new() { Id = id, Name = tableRequest.Name, IsReservable = tableRequest.IsReservable, SessionId = sessionId };
