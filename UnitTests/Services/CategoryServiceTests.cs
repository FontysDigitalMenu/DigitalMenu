...
public class CategoryServiceTests
{
    ...
    public void Setup()
    {
        ...
        _categoryService = new CategoryService(_mockCategoryRepository.Object, _mockTranslationService.Object);
    }
    ...
    //
    //     // Act
    //     Category result = await _categoryService.CreateCategory(categoryName, "en");
    //
    //     // Assert
    ...
    public void CreateCategory_NullOrEmptyName_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        Assert.ThrowsAsync<ArgumentException>(() => _categoryService.CreateCategory(categoryName, "en"));
    }
}